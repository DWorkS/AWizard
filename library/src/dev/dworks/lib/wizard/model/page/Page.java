...
package dev.dworks.lib.wizard.model.page;

import java.util.ArrayList;

import android.os.Bundle;
import android.support.v4.app.Fragment;
import dev.dworks.lib.wizard.model.PageTreeNode;
...
public abstract class Page implements PageTreeNode {
    ...
    protected WizardModelCallbacks mCallbacks;
    ...
    protected Page(WizardModelCallbacks callbacks, String title) {
    ...
    public final void resetData(Bundle data) {
        mData = data;
        notifyDataChanged();
    }
    ...
    public final Page setRequired(boolean required) {
        mRequired = required;
        return this;
    }
}