...
package dev.dworks.lib.wizard.model;
 ...
 */
public abstract class WizardModel implements WizardModelCallbacks {
    protected Context mContext;

    private List<WizardModelCallbacks> mListeners = new ArrayList<WizardModelCallbacks>();
    ...
    public void registerListener(WizardModelCallbacks listener) {
    ...
    public void unregisterListener(WizardModelCallbacks listener) {
